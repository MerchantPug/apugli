...
public class ApoliForgeDataTypes {
    ...
    public static final Lazy<SerializableDataType<Holder<ConfiguredPower<?, ?>>>> POWER_TYPE = Lazy.of(() -> new SerializableDataType<>(castClass(ConfiguredPower.class), ConfiguredPower.HOLDER));
