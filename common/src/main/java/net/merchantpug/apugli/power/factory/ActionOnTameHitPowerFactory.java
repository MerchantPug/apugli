...
public interface ActionOnTameHitPowerFactory<P> extends TameHitActionPowerFactory<P> {
    ...
    default void execute(TamableAnimal tamable, DamageSource source, float amount, LivingEntity target) {
        this.execute(tamable, tamable, target, source, amount);
    }
